                ...
                <div class="p-5">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="toggle-vis dropdown-item" data-column="0"> Room ID</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="1"> Avail</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="2">Hotel Name</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="toggle-vis dropdown-item" data-column="3">Room Floor</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="4">Due Date</a></li>
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <%
                            ...
                            //        RoomService roomServices = new RoomServiceImpl();
                            RoomAvailabilityServices roomAvailServices = new RoomAvailabilityServicesImpl();
                            //        RoomAvailabilityServices roomAvailServices = new RoomAvailabilityServicesImpl();

                            List<RoomAvailability> AvailRooms = roomAvailServices.getAvailRooms(Integer.parseInt(id));
...
//                                out.println("<td>" + AvailRooms.get(i).getRooms().getRoomId() + "</td>");
                                  out.println("<td>" + AvailRooms.get(i).getRooms().getRoomNumber() + "</td>");
//                                        getRoomAvailabilityStatus()+ "</td>");
                                out.println("<td>" + AvailRooms.get(i).getRooms().getHotels().getHotelName() + "</td>");
                                out.println("<td>" + AvailRooms.get(i).getRooms().getRoomFloor() + "</td>");
                                out.println("<td>" + AvailRooms.get(i).getRoomAvailabilityStatus() + "</td>");
                                out.println("<td>" + AvailRooms.get(i).getDueDate() + "</td>");
...
//                                        + "<input type= 'submit' name='book_room'  id='bookRoom' value='Book Room' class='btn btn-primary'>"
//                                        //                                        + "<input type='hidden' name= 'hotel' value='" + rooms.get(i).getRoomId() + "'"
//                                        + "</form></td>");
