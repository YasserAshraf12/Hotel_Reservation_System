...
public class Users  implements java.io.Serializable {
     ...
     private Set adminmessagesesForMessageFrom = new HashSet(0);
     private Set commentses = new HashSet(0);
     private Set bookings = new HashSet(0);
     private Set adminmessagesesForMessageTo = new HashSet(0);
    ...
    public Users(City city, Country country, UserType userType, String userFirstName, String userLastName, String userEmail, int userAge, String userUserName, String userPassword, String userAddress, String userTelefone, String userProfilePhoto, char userAccountVerified, Set adminmessagesesForMessageFrom, Set commentses, Set bookings, Set adminmessagesesForMessageTo, Set bookingDeleteHistories) {
       this.city = city;
       this.country = country;
       this.userType = userType;
       this.userFirstName = userFirstName;
       ...
       this.userAccountVerified = userAccountVerified;
       this.adminmessagesesForMessageFrom = adminmessagesesForMessageFrom;
       this.commentses = commentses;
       this.bookings = bookings;
       this.adminmessagesesForMessageTo = adminmessagesesForMessageTo;
    ...
    public Set getAdminmessagesesForMessageFrom() {
        return this.adminmessagesesForMessageFrom;
    }
    
    public void setAdminmessagesesForMessageFrom(Set adminmessagesesForMessageFrom) {
        this.adminmessagesesForMessageFrom = adminmessagesesForMessageFrom;
    }
    ...
    public Set getAdminmessagesesForMessageTo() {
        return this.adminmessagesesForMessageTo;
    }
    
    public void setAdminmessagesesForMessageTo(Set adminmessagesesForMessageTo) {
        this.adminmessagesesForMessageTo = adminmessagesesForMessageTo;
    }
