        ...
        <div class="bodyContainer slideLeft mt-5">
            <div class="container">
                <div class="p-5">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="toggle-vis dropdown-item" data-column="0">ID</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="1">First Name</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="2">Last Name</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="toggle-vis dropdown-item" data-column="3">Email</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="4">Age</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="5">Username</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="toggle-vis dropdown-item" data-column="6">Country</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="7">City</a></li>
                            <li><a class="toggle-vis dropdown-item" data-column="8">Address</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="toggle-vis dropdown-item" data-column="9">Telefone</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <%
                            HotelService hotelServices = new HotelServiceImpl();
                            List<Hotels> hotels = hotelServices.selectHotels();
                            SpecificHotelFeatureService shfServices = new SpecificHotelFeaturesServiceImpl();
                            for (int i = 0; i < hotels.size(); i++) {
                                out.println("<tr>");
                                out.println("<td>" + hotels.get(i).getHotelId() + "</td>");
                                out.println("<td>" + hotels.get(i).getHotelChains().getHotelChainName() + "</td>");
                                out.println("<td>" + hotels.get(i).getHotelName() + "</td>");
                                out.println("<td>" + hotels.get(i).getHotelStars() + "<i class='fas fa-star stars'></td>");
                                out.println("<td>" + hotels.get(i).getEmailAddress() + "</td>");
                                out.println("<td>" + hotels.get(i).getCountry().getCountryName() + "</td>");
                                out.println("<td>" + hotels.get(i).getHotelAddress() + "</td>");
                                //TODO
////                                            out.println("<td>" + "-" + "</td>");
//                                            out.println("<td>" + "-" + "</td>");
//                                            out.println("<td><form method='POST' action='/client/roomTable.jsp'>"
//                                                    + "<input type= 'submit' name='see_more'  id='seeMore' value='See More' class='btn btn-primary'>"
//                                                    + "<input type='hidden' name= 'hotel' value='" + hotels.get(i).getHotelId()+ "'" 
//                                                    + "</form></td>");

                                out.println("<td> <a href='roomTable.jsp?id=" + hotels.get(i).getHotelId() + "' " + "id='viewHotel' class='btn btn-info'> see More</a></td>");
                                        out.print("<td><button type='button' class='btn btn-primary' data-toggle='modal'data-target='#exampleModal' > Rate Hotel</button></td>");                      
//                                out.println("<td><button  type = 'button' class='btn btn-primary' data - toggle = 'modal' data - target = '#exampleModal'  >Rate Hotel</button></td>");
//                                        > //out.println("<td><form method='POST'>"
                                //                                                    + "<input type= 'submit' name='delete_user'  id='deleteBtn' value='Delete' class='btn btn-secondary'>"
                                //                                                    + "<input type='hidden' name= 'user' value='" + hotels.get(i).getHotelId() + "'" 
                                //                                                    + "</form></td>");
                                out.println("</tr>");
                            }
                        %>
        ...
        <!--===============================================================================================--->
        <script src="<%=request.getContextPath()%>/js/hotelTable.js"></script>
