                ...
                <div class="container">
                    ...
                    <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                        ...
                                        <li><a class="toggle-vis dropdown-item" data-column="1">Hotel Chain</a></li>
                                        <li><a class="toggle-vis dropdown-item" data-column="2">Hotel Name</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="toggle-vis dropdown-item" data-column="3">Country</a></li>
                                        <li><a class="toggle-vis dropdown-item" data-column="4">Address</a></li>
                                        <li><a class="toggle-vis dropdown-item" data-column="5">Photos</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="toggle-vis dropdown-item" data-column="6">Features</a></li>
                            </ul>
                        </div>
                    </div>
                     <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        {
                                            out.println("<tr>");
                                            out.println("<td class='hotelId'>" + hotels.get(i).getHotelId()+ "</td>");
                                            ...
                                            out.println("<td><form method='POST'>"
                                                    + "<input type= 'submit' name='edit_hotel'  id='editHotel' value='Edit' class='btn btn-primary'>"
